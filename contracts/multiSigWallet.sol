...
//  NOTE: helper function to easily deposit in remox
    ...
    function submitTxn(address _to, uint _value, bytes memory data) 
    public onlyOwner 
    {  
        ...
        emit SubmitTxn(msg.sender, txIndex, _to, _value, data);
     }

    function confirmTxn(uint _txIndex) 
        public 
        onlyOwner
        txExists(_txIndex)
    ...
    function revokeTxn(uint _txIndex) public 
    onlyOwner
    txExists(_txIndex)
    notExecuted(_txIndex) 
    {
